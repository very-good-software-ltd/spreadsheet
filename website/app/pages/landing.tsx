      ...
      <section className="border-t border-gray-100 px-6 py-16 dark:border-gray-900">
        <div className="mx-auto max-w-3xl">
          ...
          <p className="mt-4 text-gray-600 dark:text-gray-300">
            ...
            than get wrong, so a comment sitting below your data, or a pivot table reading from it, stops the save and
            tells you which. And we haven't seen the years of odd real-world files the older libraries have. If that's
