      ...
      <section className="border-t border-gray-100 px-6 py-16 dark:border-gray-900">
        <div className="mx-auto max-w-3xl">
          ...
          <p className="mt-4 text-gray-600 dark:text-gray-300">
            ...
            only write <code className="font-mono">.xlsx</code>, nothing more exotic. Rows are written over, never
            inserted. And we haven't seen the years of odd real-world files the older libraries have. If that's fine for
            what you're building, give it a try.
          </p>
        </div>
      </section>
      <Features />
